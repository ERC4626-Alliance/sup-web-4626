  ...
  return (
    <div className="bg-gradient-to-t from-pink-50 py-16 text-center" id="bounties">
      <Container>
        ...
        <ul className="space-y-2 mt-16 space-y-8 text-left text-slate-700">
          <li className="flex select-none flex-col justify-between space-y-8 rounded-lg bg-pink-100 p-8 shadow-lg my-8 lg:flex-row lg:items-center lg:space-y-0">
            <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:space-y-0 lg:space-x-10">
              ...
              <div className="lg:w-[124px]">
                ...
                <div className="text-sm text-gray-400 whitespace-nowrap">Rewards up to</div>
              </div>
              <div>
                <div className="text-sm font-medium tracking-tight">
                  ...
                  <a
                    ...
                    className="inline-flex text-pink-700 underline decoration-from-font underline-offset-4 md:no-underline md:hover:text-pink-900 md:hover:underline"
                    target="_blank"
              ...
              <div>
                <div className="flex items-center space-x-[2px] font-extrabold uppercase text-green-700">
