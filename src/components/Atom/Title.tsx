...
const AtomTitle = ({ children, alignText = "left", inverted = false }: PropsWithChildren<{ alignText?: string; inverted?: boolean; }>) => {
  ...
  return <>
    <h2 className={`text-4xl font-extrabold max-w-[80vw] md:max-w-full tracking-tight text-gray-900 sm:text-4xl inline-flex mb-8 mx-auto text-${alignText}`} data-aos="fade-up" data-aos-delay="100">
